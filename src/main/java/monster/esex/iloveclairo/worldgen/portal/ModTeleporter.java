package monster.esex.iloveclairo.worldgen.portal;

import monster.esex.iloveclairo.block.ModPortalBlock;
...
public class ModTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, BlockInit.SUS_BLOCK.get().defaultBlockState(), 3);
            }
        }

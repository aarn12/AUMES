...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public ModChestBoatEntity(Level pLevel, double pX, double pY, double pZ) {
        this(EntityInit.JACARANDA_CHEST_BOAT.get(), pLevel);
    ...
    public Item getDropItem() {
        switch (getModVariant()) {
            case JACARANDA -> {
                return ItemInit.JACARANDA_CHEST_BOAT.get();
            }
        }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.JACARANDA.ordinal());
    }

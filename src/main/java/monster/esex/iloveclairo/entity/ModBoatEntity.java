package monster.esex.iloveclairo.entity;
...
public class ModBoatEntity extends Boat {
    ...
    public ModBoatEntity(Level level, double pX, double pY, double pZ) {
        this(EntityInit.JACARANDA_BOAT.get(), level);
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case JACARANDA -> ItemInit.JACARANDA_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.JACARANDA.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        JACARANDA(BlockInit.JACARANDA_PLANKS.get(), "jacaranda");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, JACARANDA);
        }
    }
